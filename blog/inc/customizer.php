	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		...
		$wp_customize->selective_refresh->add_partial(
			...
			array(
				...
				'render_callback' => 'blog_customize_partial_blogdescription',
			)
		);
	}
}
 ...
 * @return void
 */
function blog_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function blog_customize_partial_blogdescription() {
...
function blog_customize_preview_js() {
	wp_enqueue_script( 'blog-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
